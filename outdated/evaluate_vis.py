...
from data.dataset import WeatherDataset, FinanceDataset, SocialGoodDataset
from utils import normalize_timeseries
from TS_Encoder.mome_v1 import MoMe_vis1, MoMe_vis2
from TS_Encoder.mome import MoMe
from TS_Encoder.mmlinear_v1 import MMLinear
...
def load_model_components(args):
    ...
    elif args.task in ['finance_forecast', 'weather_forecast', 'socialgood_forecast']:
...
def evaluate_full_test_set(
    ...
    if args.task in ['weather_forecast', 'finance_forecast', 'socialgood_forecast']:
...
if __name__ == "__main__":
    ...
    #CUDA_VISIBLE_DEVICES=0 python evaluate_vis.py --task socialgood_forecast --in_len 14 --out_len 3 --dataset_path ./data/processed/TimeMMD/SocialGood/test --batch_size 1 --checkpoint_path output/socialgood_mome/ts_encoder_epoch7.pt  --output_dir ./output/Expert_Selection/socialgood_mome --hidden_dim 32 --patch_len 4 --n_experts 4 --topk 2 --ts_encoder MoMe --use_bfloat16 --modulation --instructor_query 3
    #CUDA_VISIBLE_DEVICES=0 python evaluate_vis.py --task socialgood_forecast --in_len 14 --out_len 3 --dataset_path ./data/processed/TimeMMD/SocialGood/test --batch_size 1 --checkpoint_path output/socialgood_momep/ts_encoder_epoch7.pt  --output_dir ./output/Expert_Selection/socialgood_momep --hidden_dim 32 --patch_len 4 --n_experts 4 --topk 2 --ts_encoder MoMeP --use_bfloat16 --modulation --instructor_query 3
