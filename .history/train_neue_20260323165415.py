...
def parse_args():
    ...
    # -------- Model & Data --------
    parser.add_argument("--llm_model", default="./llm/Qwen-0.5B")
...
def main():
    ...
    device = args.device
    dtype = torch.float32#torch.bfloat16 if args.use_bfloat16 and torch.cuda.is_bf16_supported() else torch.float32
